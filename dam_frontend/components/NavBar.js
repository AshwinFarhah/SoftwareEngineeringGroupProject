  ...
  return (
    <Box bg="white" boxShadow="sm" px={6} py={3}>
      <Flex align="center">
        ...
        <Spacer />
        <Text mr={4} fontSize="sm" color="gray.600">{username} ({role})</Text>
        <Button size="sm" colorScheme="red" variant="outline" onClick={() => { localStorage.clear(); router.push('/login'); }}>Logout</Button>
      </Flex>
    </Box>
  );
}
